...
export default function App() {
  ...
  // BASE_URL è impostato da Vite in base a vite.config.ts
  // In produzione (GitHub Pages): '/stocksafe/'
  // In sviluppo locale: '/'
  // BrowserRouter ha bisogno del basename SENZA slash finale: '/stocksafe'
