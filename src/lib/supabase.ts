    ...
    Tables: {
      ...
      locations: {
        Row: {
          ...
          description: string; sort_order: number; is_default: boolean; created_at: string
        }
        Insert: { user_id: string; name: string; icon?: string; color?: string; description?: string; sort_order?: number; is_default?: boolean }
        Update: { name?: string; icon?: string; color?: string; description?: string; sort_order?: number }
      }
      reminders: {
